...
<%
						String avt = "";
// 					String id = " ";
					Object principal1 = org.springframework.security.core.context.SecurityContextHolder.getContext().getAuthentication()
							.getPrincipal();
					if (principal1 instanceof org.springframework.security.core.userdetails.UserDetails) {
						avt = ((User) principal1).getAvatar();
// 						id = String.valueOf(((User)principal).getId());

					}
					
					%>
				<img src="/upload_avt/<%=avt%>">
<%-- 				<img src="/upload_avt/${user.avatar }"> --%>
			</div>
			<div>
