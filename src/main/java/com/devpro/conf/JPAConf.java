...
public class JPAConf {
	...
	@Bean(destroyMethod = "close") protected DataSource dataSource() {
        ...
        dataSourceConfig.setJdbcUrl("jdbc:mysql://localhost:3306/shopjava10?useUnicode=yes&characterEncoding=UTF-8");
	...
	protected LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.devpro.entities");  //root
